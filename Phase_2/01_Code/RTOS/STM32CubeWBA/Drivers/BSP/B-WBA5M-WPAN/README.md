# BSP B-WBA5M-WPAN-BSP Component

![latest tag](https://img.shields.io/github/v/tag/STMicroelectronics/b-wba5m-wpan-bsp.svg?color=brightgreen)
...
This **b-wba5m-wpan-bsp** MCU component repository is one element of the **STM32CubeWBA** MCU embedded software package, providing the **B-WBA5M-WPAN** BSP BOARD component part.

## Release note

Details about the content of this release are available in the release note [here](https://htmlpreview.github.io/?https://github.com/STMicroelectronics/b-wba5m-wpan-bsp/blob/main/Release_Notes.html).
