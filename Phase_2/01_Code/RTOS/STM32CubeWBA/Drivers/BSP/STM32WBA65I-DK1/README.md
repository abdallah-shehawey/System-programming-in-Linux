# STM32WBA65RI-DK1 BSP Board Driver MCU Software Component

![latest tag](https://img.shields.io/github/v/tag/STMicroelectronics/stm32wba65ri-dk1-bsp.svg?color=brightgreen)
...
This repository provides the STM32Cube **STM32WBA65RI-DK1** BSP Board Driver of the **STM32CubeWBA** MCU firmware.

## Release note

Details about the content of this release are available in the release note [here](https://htmlpreview.github.io/?https://github.com/STMicroelectronics/stm32wba65ri-dk1-bsp/blob/main/Release_Notes.html).
