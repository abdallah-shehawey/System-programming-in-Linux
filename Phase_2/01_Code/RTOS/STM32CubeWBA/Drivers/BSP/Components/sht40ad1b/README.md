# SHT40AD1B DIGITAL HUMIDITY AND TEMPERATURE SENSOR BSP Component Driver MCU Software Component

![latest tag](https://img.shields.io/github/v/tag/STMicroelectronics/stm32-sht40ad1b.svg?color=brightgreen)
...
This repository provides the STM32Cube **SHT40AD1B** BSP Component Driver, **common to every** STM32Cube MCU firmware that supports it.

## Release note

Details about the content of this release are available in the release note [here](https://htmlpreview.github.io/?https://github.com/STMicroelectronics/stm32-sht40ad1b/blob/main/Release_Notes.html).
